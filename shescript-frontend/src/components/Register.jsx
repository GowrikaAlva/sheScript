    ...
    <div style={{
      ...
      <div style={{ width: "100%", maxWidth: 440 }}>
        ...
        >
          ...
          <FieldGroup label="Full Name" name="name" type="text" placeholder="Jane Doe" value={form.name} onChange={handleChange} />
          <FieldGroup label="Email Address" name="email" type="email" placeholder="jane@example.com" value={form.email} onChange={handleChange} />
          <FieldGroup label="Password" name="password" type="password" placeholder="Min 6 characters" value={form.password} onChange={handleChange} />
          <FieldGroup label="Confirm Password" name="confirm" type="password" placeholder="Repeat password" value={form.confirm} onChange={handleChange} />
          ...
          <p style={{
            ...
            <Link to="/login" style={{ color: "#2E7D5E", fontWeight: 600, textDecoration: "none" }}>
              Log in
            </Link>
          </p>
        </form>
